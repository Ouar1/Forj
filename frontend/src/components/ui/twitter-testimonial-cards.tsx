  ...
  const defaultCards: TestimonialCardProps[] = [
    {
      ...
      handle: "@cmendoza",
      content: "Forj transformó nuestra infraestructura de red. Pasamos de tener caídas constantes a un 99.9% de uptime. El cableado estructurado y los servidores NAS funcionan de maravilla.",
      date: "Mar 10, 2026",
      verified: true,
      likes: 89,
      retweets: 12,
    },
    {
      ...
      handle: "@laurag_tech",
      content: "Instalaron toda la red WiFi corporativa en un fin de semana sin interrumpir la operación. Cobertura perfecta en toda la oficina. Muy profesionales y eficientes.",
      date: "Feb 22, 2026",
      verified: true,
      likes: 62,
      retweets: 8,
    },
    {
      ...
      handle: "@mangelruiz",
      content: "Con los servidores NAS y los backups automatizados de Forj dormimos tranquilos. La recuperación ante desastres funciona, lo hemos probado. Servicio excepcional.",
      date: "Feb 8, 2026",
      verified: true,
      likes: 234,
      retweets: 45,
